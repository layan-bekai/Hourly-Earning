...
Original file is located at
    https://colab.research.google.com/drive/1r78JKK1vsYJJS_nDOj2MU_c-y_6V1lfW
"""
...
# Visualization 4: Scatter Plot with Slider
...
filtered_scatter_data_us = df[(df['year'] >= selected_min_year) &
                               (df['year'] <= selected_max_year) &
...
fig_scatter_slider_us = px.scatter(
    ...
    y='amount',
    color='gender',
    title='Earnings vs. Year (Selected Range) for United States',
